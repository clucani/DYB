...
class PHPExcel_Best_Fit
{
	...
	protected function _calculateGoodnessOfFit($sumX,$sumY,$sumX2,$sumY2,$sumXY,$meanX,$meanY, $const = null) {
		...
		$multiplier = $this->_valueCount * $sumY2 - pow($sumY,2);
		if($multiplier == 0) {
			$this->_correlation = 0;
		} else {
			$this->_correlation = ($this->_valueCount * $sumXY - $sumX * $sumY) / sqrt(($this->_valueCount * $sumX2 - pow($sumX,2)) * $multiplier);
		}	
